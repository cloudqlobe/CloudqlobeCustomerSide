...
">                            <div className="flex items-center gap-2 mb-4">
                            ...
                            <div className="space-y-3">
                                ...
                                <div>
                                    <input
                                        type="text"
                                        value={userDetails.teamsId}   // ✅ correct key
                                        onChange={(e) =>
                                            handleUserChange("teamsId", e.target.value)
                                        }
                                        className={`w-full p-3 border ${errors.teamsId ? "border-red-500" : "border-gray-200"
                                            } rounded-lg text-sm focus:ring-2 focus:ring-emerald-400 focus:border-transparent transition-all`}
