...
const Aboutanimation = () => {
  return (
    <div className="bg-[#0a2463] text-white font-sans">
      {/* Top Section */}
      <section className="py-8 md:py-16 px-4 md:px-6 lg:px-16">
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center max-w-7xl mx-auto">
          
          {/* Left Content */}
          <div className="space-y-6 animate-fade-in">
            <h1 className="text-3xl md:text-4xl font-default leading-tight">
              Welcome to <span className="text-yellow-400">CloudQlobe</span>
            </h1>
            <p className="text-white text-sm md:text-[15px] leading-relaxed text-justify mb-8">
          ...
          {/* Right Register Form */}
<div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-xl p-4 shadow-lg animate-slide-up max-w-sm mx-auto">
      ...
      {/* Bottom Feature Grid */}
      <section className="py-8 md:py-12 px-4 md:px-6 lg:px-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
          {[
            ...
            <div
              key={index}
              className="border-2 border-yellow-400 bg-white/10 backdrop-blur-lg p-4 rounded-xl shadow-[0_4px_20px_rgba(255,255,255,0.1)] text-center group hover:scale-[1.03] transition-transform duration-300"
            >
