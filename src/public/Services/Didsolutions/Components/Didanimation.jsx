...
const Didanimation = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a2463] text-white p-4 md:p-6 lg:p-10 space-y-8 md:space-y-12 lg:space-y-16">
      {/* Top Section */}
      <div className="flex flex-col lg:flex-row gap-6 md:gap-8 lg:gap-10">
        {/* Left Side - New Pattern */}
        <div className="flex-1 space-y-4 md:space-y-6 bg-gradient-to-br from-yellow-400/10 to-yellow-600/5 p-6 md:p-8 rounded-2xl border border-yellow-400">
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-default leading-snug text-yellow-400">
          ...
          <div className="grid grid-cols-2 gap-3 md:gap-4 text-xs md:text-sm">
            <div className="bg-yellow-400/10 border border-yellow-400 rounded-lg p-3 md:p-4">
        ...
        <div className="flex-1 bg-transparent border-2 border-yellow-400 text-white rounded-2xl p-6 md:p-8 shadow-xl w-full lg:max-w-xl">
          <h2 className="text-xl md:text-2xl font-bold text-yellow-400 mb-4 md:mb-6">Register for DID Access</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        {tabsDataSet1.map((item, idx) => {
          ...
          return (
            <div
              key={idx}
              className="bg-transparent border-2 border-yellow-400 rounded-xl p-4 md:p-6 text-center shadow-lg hover:bg-yellow-400 hover:text-[#0a2463] transition group"
            >
              <div className="flex justify-center mb-2 md:mb-3 text-yellow-400 group-hover:text-[#0a2463]">
