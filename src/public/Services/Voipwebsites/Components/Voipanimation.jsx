...
const Voipanimation = () => {
  return (
    <div className="min-h-screen bg-[#0a2463] text-white px-4 sm:px-6 md:px-8 py-8 md:py-12 lg:py-16 space-y-12 md:space-y-16 lg:space-y-20">
      {/* Top Section */}
      <div className="flex flex-col lg:flex-row gap-6 lg:gap-10">
        {/* Left Content - New Modern VoIP Style */}
        <div className="flex-1 flex flex-col justify-center p-6 md:p-8 rounded-2xl bg-gradient-to-b from-orange-400/10 to-transparent border border-orange-400">
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-default leading-snug text-orange-400 mb-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-5">
            <div className="flex items-center gap-2 md:gap-3 bg-orange-400/10 p-3 md:p-4 rounded-lg border border-orange-400">
              <Network className="text-orange-400 flex-shrink-0" size={20} />
              <span className="text-sm md:text-base">SIP Trunking</span>
            </div>
            <div className="flex items-center gap-2 md:gap-3 bg-orange-400/10 p-3 md:p-4 rounded-lg border border-orange-400">
              <Cloud className="text-orange-400 flex-shrink-0" size={20} />
              <span className="text-sm md:text-base">Cloud PBX</span>
            </div>
            <div className="flex items-center gap-2 md:gap-3 bg-orange-400/10 p-3 md:p-4 rounded-lg border border-orange-400">
              <Shield className="text-orange-400 flex-shrink-0" size={20} />
              <span className="text-sm md:text-base">Secure Calls</span>
            </div>
            <div className="flex items-center gap-2 md:gap-3 bg-orange-400/10 p-3 md:p-4 rounded-lg border border-orange-400">
              <Headphones className="text-orange-400 flex-shrink-0" size={20} />
        ...
        <div className="flex-1 bg-transparent border-2 border-orange-400 text-white rounded-2xl p-6 md:p-8 shadow-xl w-full lg:max-w-xl">
          <h2 className="text-xl md:text-2xl font-default text-orange-400 mb-4 md:mb-6">Request a VoIP Demo</h2>
